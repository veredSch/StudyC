...
namespace StudyC.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(StudyCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,Mail")] User user)
        {
            ...
            if (q.Count() > 0)
            {
                ...
                HttpContext.Session.SetString("login", q.First().UserName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Password,Mail")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
